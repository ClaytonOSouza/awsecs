node {
    ...
    stage('Build image') {
        sh "docker build --build-arg APP_NAME=sitemeu -t 328527480917.dkr.ecr.us-east-1.amazonaws.com/sitemeu:v2 -f Dockerfile ."
    }
    stage('Push image') {
        docker.withRegistry('https://328527480917.dkr.ecr.us-east-1.amazonaws.com', 'ecr:us-east-1:328527480917') {
            sh "docker push 328527480917.dkr.ecr.us-east-1.amazonaws.com/sitemeu:v2"
        }
    }
}
